...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/applecoin-project/applecoin>";
    const std::string URL_WEBSITE = "<https://applecoin.org>";
